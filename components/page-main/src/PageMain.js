...
export class PageMain extends LitElement {
  ...
  render() {
    ...
    <div id="eReceta">
      ...
      <p class="texto">Lector público, podría ser bloqueado a sólo usuarios autorizados (farmacias), puede grabar en base de datos si receta fue despachada, evitando doble venta de producto, lo que permitiría recetas digitales "retenidas"</p>
      <p><strong>No debe ser utilizada para recetas reales</strong></p>
      <p>Si necesita más información puede <a href="mailto:contacto@newtri.cl?Subject=eReceta" target="_blank" rel="noopener noreferrer">enviarnos un email<a></p>
    </div>
    `;
  }
}
